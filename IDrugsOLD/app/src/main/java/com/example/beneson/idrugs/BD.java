...
public class BD {
    ...
    public void inserir(Ofertado ofertado) {
        ...
        valoresOfertado.put("idProduto", ofertado.getProduto().getObjectId());
        valoresOfertado.put("idEstabelecimento", ofertado.getEstabelecimento().getObjectId());
        valoresOfertado.put("preco", ofertado.getPreco());
        valoresOfertado.put("formaFarmaceutica", ofertado.getFormaFarmaceutica());
        ...
        valoresProduto.put("_idProduto", ofertado.getProduto().getObjectId());
        ...
        valoresEstabelecimento.put("velocidade", ofertado.getEstabelecimento().getVelocidade());
        if(ofertado.getEstabelecimento().getGeolocaliacao()!=null){
            valoresEstabelecimento.put("geo_lat", ofertado.getEstabelecimento().getGeolocaliacao().getLatitude());
            valoresEstabelecimento.put("geo_lng", ofertado.getEstabelecimento().getGeolocaliacao().getLongitude());
        }
